class Platformer extends Phaser.Scene {
    ...
    create() {
        ...
        my.sprite.player = this.physics.add.sprite(this.spawnX, 200, "platformer_characters", "tile_0000.png");
        ...
        //diamond power-up collision handling
        ...
        my.vfx.coinParticles = this.add.particles(0, 0, "kenny-particles", {
